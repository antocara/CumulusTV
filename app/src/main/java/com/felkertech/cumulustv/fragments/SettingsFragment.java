...
public class SettingsFragment extends LeanbackSettingsFragment
  ...
  @Override public boolean onPreferenceStartFragment(PreferenceFragment preferenceFragment,
      Preference preference) {
    return false;
  }

  @Override public boolean onPreferenceStartScreen(PreferenceFragment preferenceFragment,
  ...
  @Override public Preference findPreference(CharSequence charSequence) {
  ...
  public static class PrefFragment extends LeanbackPreferenceFragment {
    ...
    @Override public void onCreatePreferences(Bundle bundle, String s) {
      ...
      if (root == null) {
        ...
        try {
          findPreference("VERSION").setTitle("v" + getActivity().getPackageManager()
    ...
    @Override public boolean onPreferenceTreeClick(Preference preference) {
      if (preference.getKey().equals("PRINT_DATABASE")) {
        new AlertDialog.Builder(
            new ContextThemeWrapper(getActivity(), R.style.Theme_AppCompat_Dialog)).setTitle(
            R.string.print_database)
        ...
        updateChannels(getActivity(),
            "com.felkertech.n.cumulustv/com.felkertech.cumulustv.tv.tvinputservice.CumulusTvTifService",
            tvChannels);

        Cursor cursor = getActivity().getContentResolver()
            .query(TvContract.buildChannelsUriForInput(
                "com.felkertech.n.cumulustv/com.felkertech.cumulustv.tv.tvinputservice.CumulusTvTifService"), null,
                null, null, null);
        Log.d("S", "Query from " + TvContract.buildChannelsUriForInput(
            "com.felkertech.n.cumulustv/com.felkertech.cumulustv.tv.tvinputservice.CumulusTvTifService"));
        ...
        new AlertDialog.Builder(
            new ContextThemeWrapper(getActivity(), R.style.Theme_AppCompat_Dialog)).setTitle(
            R.string.print_database).setMessage(builder.toString()).show();
        return true;
  ...
  public static void updateChannels(Context context, String inputId, List<Channel> channels) {
    ...
    String[] projection =
        { TvContract.Channels._ID, TvContract.Channels.COLUMN_ORIGINAL_NETWORK_ID };
    ...
    for (int i = 0; i < size; ++i) {
      ...
      SharedPreferences.Editor editor =
          context.getSharedPreferences(BaseTvInputService.PREFERENCES_FILE_KEY,
