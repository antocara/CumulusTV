...
public class PlaybackQuickSettingsActivity extends Activity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    try {
      final JsonChannel jsonChannel =
          new JsonChannel.Builder(getIntent().getStringExtra(EXTRA_JSON_CHANNEL)).build();
      ...
      quickSettings[0] =
          new RecyclerViewItem(getString(R.string.edit_channel_name, jsonChannel.getName())) {
      ...
      quickSettings[1] = new RecyclerViewItem(getString(R.string.open_cumulus_tv)) {
        @Override public void onClick() {
          NavigationManager.navigateToMainActivity(PlaybackQuickSettingsActivity.this);
        }
      };
      ...
      quickSettings[2] = new RecyclerViewItem(getString(R.string.report_playback_issue)) {
        @Override public void onClick() {
          throw new PlaybackIssueException("Issue found with playback: " + jsonChannel.toString());
        }
      };
  ...
  private class AppLinkMenuAdapter extends RecyclerViewColumnAdapter {
    ...
    @Override public RecyclerView.ViewHolder createNewViewHolder(View view) {
